...
AUDIOMNIST_DATA_FOLDER = "/home/elisam/projects/def-ravanelm/elisam/speechbrain/recipes/digit_recognition/audioMNIST/data/recordings"
SAMPLERATE = 8000
...
def create_json(wav_list, json_file):
    ...
    json_dict = {}
    for wav_file in tqdm(wav_list, desc=f"Processing .wav Files for {json_file}", unit="file"):
        ...
        # This might need another split TEST WHEN SALLOC WORKS SMH
        dgt_id = uttid.split("-")[0].split("_")[0]
